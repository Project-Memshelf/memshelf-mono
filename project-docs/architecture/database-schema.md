...
The Memshelf database schema is designed for **flexibility**, **performance**, and **data integrity**. Built for MariaDB with TypeORM, it supports complex knowledge relationships while maintaining query efficiency.
...
- `version` - INT, DEFAULT 1 - TypeORM optimistic locking
